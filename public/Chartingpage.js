...
function handleTableCellClick(event, prefix) {
  // Trouver la cellule parente si l'utilisateur clique à l'intérieur d'un élément comme un numéro
  const targetCell = event.target.closest('td, th');
  
  if (!targetCell) return; // Si aucune cellule n'est trouvée, ne rien faire
